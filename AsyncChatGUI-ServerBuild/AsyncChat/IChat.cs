...
namespace AsyncChat
{
    ...
    public interface IChat
    {
        void connect();
        void disconnect();
        void sendMessage(MessageArgs message);
        void listen();
    }
    ...
    /// </summary>
    public delegate void ClientConnHandler(MessageArgs message);

    /// <summary>
    /// Client disconnected from server
    /// </summary>
    /// <param name="message"></param>
    public delegate void ClientDiscHandler(MessageArgs message);
    ...
    /// </summary>
    /// <param name="message"></param>
    public delegate void MessageSentHandler(MessageArgs message);

    /// <summary>
    /// An event that fires from the library when a message is on the network stream
    /// </summary>
    /// <param name="message"></param>
    public delegate void MessageReceivedHandler(MessageArgs message);
